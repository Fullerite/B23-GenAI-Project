...
* [constructor](src_core_log_middlewares_extractor_testing.TestBaseError.html#constructor)

### Properties

* [cause](src_core_log_middlewares_extractor_testing.TestBaseError.html#cause)
* [internalMessage](src_core_log_middlewares_extractor_testing.TestBaseError.html#internalMessage)

### Methods

* [format](src_core_log_middlewares_extractor_testing.TestBaseError.html#format)

## Constructors

### constructor

* new TestBaseError(message?: string, cause?: Error): [TestBaseError](src_core_log_middlewares_extractor_testing.TestBaseError.html)
...
* Inherited from [default](src_core_error.default.html).[constructor](src_core_error.default.html#constructor)
  ...
  #### Returns [TestBaseError](src_core_log_middlewares_extractor_testing.TestBaseError.html)
