...
[### Registering a data provider as the multiton](#registering-a-data-provider-as-the-multiton)
...
[### Decorating a request function](#decorating-a-request-function)
...
[##### URL interpolation](#url-interpolation)
...
[#### Interpolation of headers](#interpolation-of-headers)
...
[##### Providing an API URL](#providing-an-api-url)
...
[### Composition of providers](#composition-of-providers)
...
[#### Static extra providers](#static-extra-providers)
...
[### Extending one data provider from another provider](#extending-one-data-provider-from-another-provider)
...
[### Specifying data mocks](#specifying-data-mocks)
...
[#### Enabling data mocks for a provider](#enabling-data-mocks-for-a-provider)
...
* [CacheStrategy](src_core_data.html#CacheStrategy)
* [CreateRequestOptions](src_core_data.html#CreateRequestOptions)
* [DataWithStatus](src_core_data.html#DataWithStatus)
* [DecodersMap](src_core_data.html#DecodersMap)
* [EncodersMap](src_core_data.html#EncodersMap)
* [ExtraProvider](src_core_data.html#ExtraProvider)
* [ExtraProviderConstructor](src_core_data.html#ExtraProviderConstructor)
* [ExtraProviderParams](src_core_data.html#ExtraProviderParams)
* [ExtraProviders](src_core_data.html#ExtraProviders)
* [FunctionalExtraProviders](src_core_data.html#FunctionalExtraProviders)
* [MiddlewareParams](src_core_data.html#MiddlewareParams)
* [Middlewares](src_core_data.html#Middlewares)
* [Mock](src_core_data.html#Mock)
* [MockCustomResponse](src_core_data.html#MockCustomResponse)
* [MockOptions](src_core_data.html#MockOptions)
* [MockResponse](src_core_data.html#MockResponse)
* [MockResponseFunction](src_core_data.html#MockResponseFunction)
* [MockResponseValue](src_core_data.html#MockResponseValue)
* [Mocks](src_core_data.html#Mocks)
* [ModelMethod](src_core_data.html#ModelMethod)
* [Provider](src_core_data.html#Provider)
* [ProviderConstructor](src_core_data.html#ProviderConstructor)
* [ProviderOptions](src_core_data.html#ProviderOptions)
* [RequestBody](src_core_data.html#RequestBody)
* [RequestError](src_core_data.html#RequestError)
* [RequestFunctionResponse](src_core_data.html#RequestFunctionResponse)
* [RequestMethod](src_core_data.html#RequestMethod)
* [RequestPromise](src_core_data.html#RequestPromise)
* [RequestQuery](src_core_data.html#RequestQuery)
* [RequestResponse](src_core_data.html#RequestResponse)
* [RequestResponseObject](src_core_data.html#RequestResponseObject)
* [Response](src_core_data.html#Response)
* [Socket](src_core_data.html#Socket)
* [attachMock](src_core_data.html#attachMock)
* [attachStatus](src_core_data.html#attachStatus)
* [connectCache](src_core_data.html#connectCache)
* [emitter](src_core_data.html#emitter)
* [globalOpts](src_core_data.html#globalOpts)
* [instanceCache](src_core_data.html#instanceCache)
* [methodProperties](src_core_data.html#methodProperties)
* [namespace](src_core_data.html#namespace)
* [provider](src_core_data.html#provider)
* [providers](src_core_data.html#providers)
* [queryMethods](src_core_data.html#queryMethods)
* [requestCache](src_core_data.html#requestCache)
* [urlProperties](src_core_data.html#urlProperties)
* [wait](src_core_data.html#wait)

### Classes

* [default](../classes/src_core_data.default.html)
...
Re-exports [DecodersMap](src_core_data_interface_types.html#DecodersMap)

### EncodersMap

Re-exports [EncodersMap](src_core_data_interface_types.html#EncodersMap)

### ExtraProvider

Re-exports [ExtraProvider](../interfaces/src_core_data_interface_types.ExtraProvider.html)

### ExtraProviderConstructor

Re-exports [ExtraProviderConstructor](src_core_data_interface_types.html#ExtraProviderConstructor)

### ExtraProviderParams

Re-exports [ExtraProviderParams](../interfaces/src_core_data_interface_types.ExtraProviderParams.html)

### ExtraProviders

Re-exports [ExtraProviders](src_core_data_interface_types.html#ExtraProviders)

### FunctionalExtraProviders

Re-exports [FunctionalExtraProviders](src_core_data_interface_types.html#FunctionalExtraProviders)
...
Re-exports [Mock](../interfaces/src_core_data_interface_types.Mock.html)

### MockCustomResponse

Re-exports [MockCustomResponse](../interfaces/src_core_data_interface_types.MockCustomResponse.html)
...
Re-exports [MockResponse](src_core_data_interface_types.html#MockResponse)

### MockResponseFunction

Re-exports [MockResponseFunction](../interfaces/src_core_data_interface_types.MockResponseFunction.html)

### MockResponseValue

Re-exports [MockResponseValue](src_core_data_interface_types.html#MockResponseValue)

### Mocks

Re-exports [Mocks](src_core_data_interface_types.html#Mocks)

### ModelMethod

Re-exports [ModelMethod](src_core_data_interface_types.html#ModelMethod)

### Provider

Re-exports [Provider](../interfaces/src_core_data_interface.Provider.html)

### ProviderConstructor

Re-exports [ProviderConstructor](../interfaces/src_core_data_interface_types.ProviderConstructor.html)

### ProviderOptions

Re-exports [ProviderOptions](../interfaces/src_core_data_interface_types.ProviderOptions.html)
...
Re-exports [Socket](src_core_socket_interface.html#Socket)

### attachMock

Re-exports [attachMock](src_core_data_middlewares_attach_mock.html#attachMock)

### attachStatus

Re-exports [attachStatus](src_core_data_middlewares_attach_status.html#attachStatus)

### connectCache

Re-exports [connectCache](src_core_data_const.html#connectCache)

### emitter

Re-exports [emitter](src_core_data_const.html#emitter)
...
Re-exports [instanceCache](src_core_data_const.html#instanceCache)

### methodProperties

Re-exports [methodProperties](src_core_data_const.html#methodProperties)

### namespace

Re-exports [namespace](src_core_data_const.html#namespace)

### provider

Re-exports [provider](src_core_data_decorators.html#provider)

### providers

Re-exports [providers](src_core_data_const.html#providers)

### queryMethods

Re-exports [queryMethods](src_core_data_const.html#queryMethods)

### requestCache

Re-exports [requestCache](src_core_data_const.html#requestCache)

### urlProperties

Re-exports [urlProperties](src_core_data_const.html#urlProperties)

### wait

Re-exports [wait](src_core_data_middlewares_wait.html#wait)