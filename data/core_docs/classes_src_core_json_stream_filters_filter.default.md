...
* [constructor](src_core_json_stream_filters_filter.default.html#constructor)

### Properties

* [depth](src_core_json_stream_filters_filter.default.html#depth)
* [expectedToken](src_core_json_stream_filters_filter.default.html#expectedToken)
* [filter](src_core_json_stream_filters_filter.default.html#filter)
* [multiple](src_core_json_stream_filters_filter.default.html#multiple)
* [objStack](src_core_json_stream_filters_filter.default.html#objStack)
* [passKey](src_core_json_stream_filters_filter.default.html#passKey)
* [passNumber](src_core_json_stream_filters_filter.default.html#passNumber)
* [passString](src_core_json_stream_filters_filter.default.html#passString)
* [previousToken](src_core_json_stream_filters_filter.default.html#previousToken)
* [skipKey](src_core_json_stream_filters_filter.default.html#skipKey)
* [skipNumber](src_core_json_stream_filters_filter.default.html#skipNumber)
* [skipString](src_core_json_stream_filters_filter.default.html#skipString)
* [stack](src_core_json_stream_filters_filter.default.html#stack)

### Accessors

* [processToken](src_core_json_stream_filters_filter.default.html#processToken)

### Methods

* [check](src_core_json_stream_filters_filter.default.html#check)
* [checkToken](src_core_json_stream_filters_filter.default.html#checkToken)
* [finishTokenProcessing](src_core_json_stream_filters_filter.default.html#finishTokenProcessing)
* [pass](src_core_json_stream_filters_filter.default.html#pass)
* [passObject](src_core_json_stream_filters_filter.default.html#passObject)
* [passValue](src_core_json_stream_filters_filter.default.html#passValue)
* [skip](src_core_json_stream_filters_filter.default.html#skip)
* [skipObject](src_core_json_stream_filters_filter.default.html#skipObject)
* [skipValue](src_core_json_stream_filters_filter.default.html#skipValue)
* [createPathFilter](src_core_json_stream_filters_filter.default.html#createPathFilter)
* [createRegExpFilter](src_core_json_stream_filters_filter.default.html#createRegExpFilter)

## Constructors

### constructor

* new default(filter: [TokenFilter](../modules/src_core_json_stream_filters_interface.html#TokenFilter)): [default](src_core_json_stream_filters_filter.default.html)
...
* Overrides [default](src_core_json_stream_filters_abstract_filter.default.html).[constructor](src_core_json_stream_filters_abstract_filter.default.html#constructor)
  ...
  + Defined in [src/core/json/stream/filters/filter.ts:22](https://github.com/V4Fire/Core/blob/master/src/core/json/stream/filters/filter.ts#L22)

  #### Parameters

  + ##### filter: [TokenFilter](../modules/src_core_json_stream_filters_interface.html#TokenFilter)

  #### Returns [default](src_core_json_stream_filters_filter.default.html)
...
Overrides [default](src_core_json_stream_filters_abstract_filter.default.html).[multiple](src_core_json_stream_filters_abstract_filter.default.html#multiple)

* Defined in [src/core/json/stream/filters/filter.ts:15](https://github.com/V4Fire/Core/blob/master/src/core/json/stream/filters/filter.ts#L15)

If true the filtration will return all matched filter results, otherwise only the first match will be returned

### Protected objStack

objStack: [FilterStack](../modules/src_core_json_stream_filters_interface.html#FilterStack) = []

* Defined in [src/core/json/stream/filters/filter.ts:20](https://github.com/V4Fire/Core/blob/master/src/core/json/stream/filters/filter.ts#L20)
...
* checkToken(chunk: [Token](../interfaces/src_core_json_stream_parser_interface.Token.html)): Generator<[Token](../interfaces/src_core_json_stream_parser_interface.Token.html), any, unknown>
...
* Overrides [default](src_core_json_stream_filters_abstract_filter.default.html).[checkToken](src_core_json_stream_filters_abstract_filter.default.html#checkToken)
  ...
  + Defined in [src/core/json/stream/filters/filter.ts:95](https://github.com/V4Fire/Core/blob/master/src/core/json/stream/filters/filter.ts#L95)
...
* finishTokenProcessing(): Generator<[Token](../interfaces/src_core_json_stream_parser_interface.Token.html), any, unknown>

* Overrides [default](src_core_json_stream_filters_abstract_filter.default.html).[finishTokenProcessing](src_core_json_stream_filters_abstract_filter.default.html#finishTokenProcessing)

  + Defined in [src/core/json/stream/filters/filter.ts:26](https://github.com/V4Fire/Core/blob/master/src/core/json/stream/filters/filter.ts#L26)
