...
* [Maybe](../interfaces/index.Maybe.html)<T>

## Index

### Constructors

* [constructor](src_core_prelude_structures_helpers.Option.html#constructor)

### Properties

* [[toStringTag]](src_core_prelude_structures_helpers.Option.html#_toStringTag_)
* [fulfillHandlers](src_core_prelude_structures_helpers.Option.html#fulfillHandlers)
* [rejectHandlers](src_core_prelude_structures_helpers.Option.html#rejectHandlers)
* [state](src_core_prelude_structures_helpers.Option.html#state)
* [type](src_core_prelude_structures_helpers.Option.html#type)
* [value](src_core_prelude_structures_helpers.Option.html#value)

### Accessors

* [isPending](src_core_prelude_structures_helpers.Option.html#isPending)

### Methods

* [call](src_core_prelude_structures_helpers.Option.html#call)
* [catch](src_core_prelude_structures_helpers.Option.html#catch)
* [finally](src_core_prelude_structures_helpers.Option.html#finally)
* [then](src_core_prelude_structures_helpers.Option.html#then)
* [unwrap](src_core_prelude_structures_helpers.Option.html#unwrap)
* [all](src_core_prelude_structures_helpers.Option.html#all)
* [allSettled](src_core_prelude_structures_helpers.Option.html#allSettled)
* [any](src_core_prelude_structures_helpers.Option.html#any)
* [race](src_core_prelude_structures_helpers.Option.html#race)
* [reject](src_core_prelude_structures_helpers.Option.html#reject)
* [resolve](src_core_prelude_structures_helpers.Option.html#resolve)

## Constructors

### constructor

* new Option<T>(executor: [Executor](../interfaces/src_core_prelude_structures_sync_promise_interface.Executor.html)<unknown>): [Option](src_core_prelude_structures_helpers.Option.html)<T>
...
* Inherited from [default](src_core_prelude_structures_sync_promise.default.html).[constructor](src_core_prelude_structures_sync_promise.default.html#constructor)
  ...
  #### Returns [Option](src_core_prelude_structures_helpers.Option.html)<T>
...
Implementation of Maybe.\_\_@toStringTag@751
...
Implementation of [Maybe](../interfaces/index.Maybe.html).[type](../interfaces/index.Maybe.html#type)

* Defined in [src/core/prelude/structures/helpers.ts:12](https://github.com/V4Fire/Core/blob/master/src/core/prelude/structures/helpers.ts#L12)
...
* Implementation of Maybe.finally
