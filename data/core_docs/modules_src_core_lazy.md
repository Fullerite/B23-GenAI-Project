...
[## Usage](#usage)
[### With a function that returns an object](#with-a-function-that-returns-an-object)
...
* [default](src_core_lazy.html#default)

## Functions

### default

* default<T>(constructor: T, scheme?: [ObjectScheme](src_core_lazy_interface.html#ObjectScheme), hooks?: [Hooks](../interfaces/src_core_lazy_interface.Hooks.html)<T extends [ClassConstructor](index.html#ClassConstructor)<any[], any> ? InstanceType<T> : T extends (...args: A) => R ? R : object>): T extends [ClassConstructor](index.html#ClassConstructor) ? T & InstanceType<T> : T extends (...args: infer  A) => infer  R ? ((...args: A) => R) & R : never

* + Defined in [src/core/lazy/index.ts:25](https://github.com/V4Fire/Core/blob/master/src/core/lazy/index.ts#L25)
  ...
  + #### T: [AnyFunction](../interfaces/index.AnyFunction.html)<any[], any> | [ClassConstructor](index.html#ClassConstructor)<any[], any>

  #### Parameters

  + ##### constructor: T
  + ##### Optional scheme: [ObjectScheme](src_core_lazy_interface.html#ObjectScheme)
  + ##### Optional hooks: [Hooks](../interfaces/src_core_lazy_interface.Hooks.html)<T extends [ClassConstructor](index.html#ClassConstructor)<any[], any> ? InstanceType<T> : T extends (...args: A) => R ? R : object>

  #### Returns T extends [ClassConstructor](index.html#ClassConstructor) ? T & InstanceType<T> : T extends (...args: infer A) => infer R ? ((...args: A) => R) & R : never