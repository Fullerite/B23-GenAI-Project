...
[# core/request/headers](#corerequestheaders)
...
[## Why not just use the native Headers class?](#why-not-just-use-the-native-headers-class)
...
[## Interpolation of headers' keys and values](#interpolation-of-headers39-keys-and-values)
...
[## Headers' instance as a simple dictionary](#headers39-instance-as-a-simple-dictionary)
...
* [HeadersForEachCb](src_core_request_headers.html#HeadersForEachCb)
* [RawHeaders](src_core_request_headers.html#RawHeaders)

### Classes

* [default](../classes/src_core_request_headers.default.html)
