# Interface AsyncRequestIdleCallbackOptions<CTX>
### Type parameters
...
* [AsyncCbOptions](src_core_async_modules_base_interface.AsyncCbOptions.html)<CTX>
...
* [group](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#group)
* [join](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#join)
* [label](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#label)
* [onClear](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#onClear)
* [onMerge](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#onMerge)
* [onMutedCall](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#onMutedCall)
* [promise](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#promise)
* [timeout](src_core_async_modules_timers_interface.AsyncRequestIdleCallbackOptions.html#timeout)
...
* Defined in [src/core/async/modules/timers/interface.ts:32](https://github.com/V4Fire/Core/blob/master/src/core/async/modules/timers/interface.ts#L32)
